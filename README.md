...
Part of the analytical expressions have been generated by Maple software,
...
For the time being, this code can be used for academic and non-comercial purposes,
acording to the above Maplesoft's licence. In the medium to long term,
we plan to generate those sections of the code with a free software so that
the non-commercial restriction can be removed.
